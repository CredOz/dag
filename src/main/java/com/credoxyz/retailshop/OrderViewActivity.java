    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            for (int i=0; i<mapList.size(); i++){
                ...
                edit.setText("Edit");
                edit.setId(Integer.valueOf(mapList.get(i).order.toString()));
                    ...
                    public void onClick(View view) {
                        for (Button button : mButtonList) {
                            if (button.getId() == view.getId()) {
                                ...
                                String ordr = Integer.toString(ordrId);
                                Intent next = new Intent(OrderViewActivity.this, OrderEditActivity.class);
                                next.putExtra("orderNo", ordr);
                                startActivity(next);
                            } else {
